const githubUrl = 'https://github.com/kripple' as const;
const linkedinUrl = 'https://www.linkedin.com/in/kellymripple' as const;
const email = 'contact@kellyripple.com' as const;
